...
export function Hero() {
  ...
  <div className="absolute inset-0 bg-black/60 lg:bg-transparent" />
      ...
      {/* Sector ticker */}
      <div className="absolute bottom-0 left-0 right-0 bg-primary backdrop-blur-xl">
        <div className="w-full overflow-x-auto">
          <ul className="flex items-center justify-between py-4 text-sm text-white px-10">
